...
func TestNormalSuccEntry(t *testing.T) {
	entry := &dirinfo.Entry{
		...
		FileList: []*dirinfo.File{
			{
				RelPathToMother: "",
				Name:            "[Eternal][Some Name][07][GB][720P][Uncensored].mp4",
				Ext:             ".mp4",
				BytesNum:        123456789,
			},
		},
	}
	parser := &EternalTeamParser{
		c:           emptyConfig,
...
func TestExplictTmdbId(t *testing.T) {
	entry := &dirinfo.Entry{
		...
		FileList: []*dirinfo.File{
			{
				RelPathToMother: "",
				Name:            "[Eternal][Some Name][07][GB][720P][Uncensored] tv tmdbid-123456789.mp4",
				Ext:             ".mp4",
				BytesNum:        123456789,
			},
		},
...
func TestWithPredefined(t *testing.T) {
	entry := &dirinfo.Entry{
		...
		FileList: []*dirinfo.File{
			{
				RelPathToMother: "",
				Name:            "[Eternal][Predefined Name][07][GB][720P][Uncensored].mp4",
				Ext:             ".mp4",
				BytesNum:        123456789,
			},
		},

...
func TestNormalSuccEntry(t *testing.T) {
	entry := &dirinfo.Entry{
		...
		FileList: []*dirinfo.File{
			{
				RelPathToMother: "",
				Name:            "[Nekomoe kissaten][Some Name][07][1080p][JPSC].mp4",
				Ext:             ".mp4",
				BytesNum:        123456789,
			},
		},
...
func TestExplictTmdbId(t *testing.T) {
	entry := &dirinfo.Entry{
		...
		FileList: []*dirinfo.File{
			{
				RelPathToMother: "",
				Name:            "[Nekomoe kissaten][Name Not Matter][07][1080p][JPSC] tv tmdbid-123456789.mp4",
				Ext:             ".mp4",
				BytesNum:        123456789,
			},
		},
...
func TestWithPredefined(t *testing.T) {
	entry := &dirinfo.Entry{
		...
		FileList: []*dirinfo.File{
			{
				RelPathToMother: "",
				Name:            "[Nekomoe kissaten][Predefined Name][07][1080p][JPSC].mp4",
				Ext:             ".mp4",
				BytesNum:        123456789,
			},
		},
